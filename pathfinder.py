...
if __name__ == "__main__":
    ...
    if args.file:
        ...
        paths = [
            ...
            "/dashboard", "/user", "/signin", "/signup", "/home", "/search", "/error", "/help",
            "/about", "/contact", "/download", "/logout", "/profile", "/register", "/forgot-password",
            "/reset-password", "/admin/login", "/admin/panel", "/admin/dashboard", "/panel",
            "/controlpanel", "/cpanel", "/db", "/data", "/settings", "/config.json", "/api/v1",
